...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $user = User::find(1);
        $user->name = 'Andy';
        $user->email = 'andy.liujin@foxmail.com';
        ...
        // 将 2 号用户指派为『管理员』
        $user = User::find(2);
        $user->assignRole('Maintainer'); // assignRole() 方法在 HasRoles 中定义，我们已在 User 模型中加载了它。
    }
}
